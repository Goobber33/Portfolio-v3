    ...
    return (
        <div id="about" className="d-flex flex-column align-items-center justify-content-center about-section" style={{ paddingTop: '7%' }}>
            <div className="text-center">
                ...
                <h1 style={{ color: '#00056B', fontSize: '4rem', fontFamily: "'DM Serif Display', serif", maxWidth: '1200px' }}>
                        My name is Kyle Parks, I am a freelance full-stack developer with a knack for creating dynamic and intuitive web experiences.
                    </h1>
                </div>
            </div>
            ...
            <div className=" mt-5" style={{ width: '100%', maxWidth: '1100px' }}>
                <div className="card-body">
                    ...
                    <h3 className="mt-4" style={{ color: '#00056B', fontSize: '2.5rem', fontFamily: "'DM Serif Display', serif" }}>Skills and Tools</h3>
                    ...
                    <h3 className="mt-4" style={{ color: '#00056B', fontSize: '2.5rem', fontFamily: "'DM Serif Display', serif" }}>Education</h3>
                    <p className="card-text" style={{ fontFamily: "'Roboto', sans-serif" }}>
                    ...
                    <h3 className="mt-4" style={{ color: '#00056B', fontSize: '2.5rem', fontFamily: "'DM Serif Display', serif" }}>Certifications</h3>
                    <p className="card-text" style={{ fontFamily: "'Roboto', sans-serif" }}>
